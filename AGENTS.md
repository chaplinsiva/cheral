...
**Project Name:** Cheral
**Description:** Cheral - Traveling Historical Trust site celebrating heritage, historical travel, and cultural trust with modern editorial elegance.
**Tech Stack:** Next.js (App Router) + Tailwind CSS + TypeScript
**Design Tokens:** Warm Off-White (`#F7F3EF`), Pure White (`#FFFFFF`), Charcoal Black (`#222222`), Medium Gray (`#6F6F6F`), Light Gray (`#D9D9D9`), Warm Peach (`#F8D7C6`), Coral Orange (`#F68B5F`), Soft Terracotta (`#E26E4D`), Sand Beige (`#E8D9CC`)
**Logo Assets:** 
...
| `docs/process/doc-ownership.md` | Who maintains what → `docs/process/doc-ownership.md` |
